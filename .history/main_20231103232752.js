...
function sortStudentsByHouse(house) {
  const filteredStudents = house === 'all' ?
    firstYearWizards :
    firstYearWizards.filter(student => student.house.toLowerCase() === house);
...
// Function to render the cards based on the given student array
