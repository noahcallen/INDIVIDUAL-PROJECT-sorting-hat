...
app.addEventListener('click', (taco) => {
  ...
  if (taco.target.id.includes('expel')) {
    ...
    if (index !== -1) { // Check for valid index before splicing
      ...
      console.log('Expelled Student:', expelledStudent); // Check expelled student
      console.log('Students:', students); // Check updated students array
      console.log('Expelled:', expelled); // Check updated expelled array
